...
function Work() {
  return (
    <section className='rounded-xl bg-neutral-950/60	 md:bg-zinc-900/90'>
      <div className='mt-20  flex flex-col gap-10 rounded-3xl py-10 px-4 text-white  h-3/6 w-full '>
        <h2
