...
const Hero = () => {
  return (
    <div className='pb-20 mt-12 sm:pt-32 2xl:pt-[110px] md:pt-20 lg:pt-32 xl:pt-[13vh] xl:mt-[5vh] xl:px-16'>
      ...
      <div>
        <Spotlight
          className='top-10 -left-7 sm:-top-40 sm:-left-10 lg:-left-32 lg:-top-20 h-[100vh] w-[100vw] lg:h-[80vh] lg:w-[50vw] '
          fill='white'
        />{' '}
        <Spotlight
        ...
        />
        <Spotlight
          className='top-0 left-0 sm:left-80 sm:top-28 h-[100vh] w-[100vw] lg:h-[80vh] lg:w-[50vw] '
          fill='red'
        />
      </div>
      ...
      <BlurFade delay={0.1} inView>
        <div className='flex max-w-[80vw] mt-16 sm:mt-0 justify-between  items-center relative lg:mb-5  z-10'>
          <div className='lg:text-left max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center sm:items-start justify-center'>
            <span className='mt-3 sm:mt-5  text-5xl lg:text-6xl xl:text-[69px]'>
            ...
            commercial, and industrial projects nationwide in India.'
              className='mt-4 text-pretty hidden font-light	 sm:block text-lg leading-loose lg:text-base text-[#BDBDBD]  lg:max-w-[50vw]'
            />
