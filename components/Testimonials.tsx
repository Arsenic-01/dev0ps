...
export function Testimonials() {
  return (
    <section className='mt-32 lg:p-16 h-full'>
      <h1 className='font-bold md:font-semi-bold  text-center  relative md:leading-relaxed text-pretty text-4xl lg:text-5xl xl:text-6xl skew-highlight'>
        Kind words from{' '}
        ...
        clients{' '}
        <span className='text-2xl md:text-4xl inline-flex justify-center items-center'>
          ✨
        </span>
      </h1>
      <Carousel
      ...
      >
        <CarouselContent className='-ml-1'>
          <CarouselItem className='pl-1 md:basis-1/2 lg:basis-1/3'>
            <div className='p-1'>
              <Card>
                <CardContent className='bg-neutral-950/60	 md:bg-zinc-900 flex aspect-square items-center justify-center p-6'>
