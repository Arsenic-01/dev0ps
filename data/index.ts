export const ProjectData = [
  {
    id: 1,
    imgSrc: '/projects/Flemingo_School_Lohner.webp',
    title: 'Flemingo School',
    type: 'institutional',
    loc: 'lohoner',
    duration: '3 months',
    description:
      'We designed the structure of the school building with a modern and functional approach, ensuring a safe and conducive learning environment for the students.',
  },
  {
    id: 2,
    imgSrc: '/projects/Raju_Patil.webp',
    title: 'Patil Plaza',
    type: 'residential',
    loc: 'mhasrul',
    duration: '3 months',
    description:
      'We offered an array of services including structural design, architectural planning, and interior design to create a modern and functional residential space.',
  },
  {
    id: 3,
    imgSrc: '/projects/m_Bad_Maratha_Mangal_Karyalaya.webp',
    title: 'Maratha Sankul',
    type: 'commericial',
    loc: 'makhmalabad',
    duration: '3 months',
    description:
      'We provided complete architectural and structural design services, creating a modern, functional commercial space, fully designed and constructed by us.',
  },
  {
    id: 4,
    imgSrc: '/projects/Rawal_M_Nagar.webp',
    title: 'Raval Complex',
    type: 'commericial',
    loc: 'mahatma nagar',
    duration: '3 months',
  ...
  {
    id: 6,
    imgSrc: '/projects/Gaware_Swapnil.webp',
    title: 'Gaware Residency',
    type: 'bungalow',
    loc: '-',
    duration: '3 months',
    description:
      'We handled the structural design, architectural solutions, and interior design of the bungalow, delivering a modern and functional living space with complete project execution.',
  },
  {
    id: 7,
    imgSrc: '/projects/Ganore Sandip.jpg',
    title: 'Ganore Residency',
    type: 'bungalow',
    loc: '-',
    duration: '3 months',
    description:
      'We crafted the structural design and delivered architectural solutions to transform the bungalow into a modern, functional home.',
  },
  {
    id: 8,
    imgSrc: '/projects/Hekare_Kailas.webp',
    title: 'Kailas Residency',
    type: 'bungalow',
    loc: '-',
    duration: '3 months',
    description:
      'We completed the project with a modern, functional design, ensuring a safe living environment, with architecture and interior design provided by us.',
  },
  {
    id: 9,
    imgSrc: '/projects/Mahindra.webp',
    title: 'Mahindra Body Incoming Shade',
    type: 'industrial',
    loc: '-',
    duration: '3 months',
    description:
      'Handled the stuctural design including load calculations, material selection, and structural analysis. This was not constructed by us.',
  },
  {
    id: 10,
    imgSrc: '/projects/pernod1.webp',
    title: 'Pernod Richard Grain Silo',
    type: 'industrial',
    loc: 'kadawa mhalungi',
    duration: '3 months',
    description:
      'We provided structural design including foundation, silo design, and load calculations. Handled the entire project from design to construction.',
  },
  {
    id: 11,
  ...
  {
    id: 12,
    imgSrc: '/projects/Vishal_Raut.webp',
    title: 'Vishal Row House',
    type: 'residential',
    loc: 'dhatrak phata',
    duration: '3 months',
    description:
      'We provided structural design and architectural solutions to create a modern, functional row house with complete project execution.',
  },
  {
    id: 13,
...
export const ServiceCardsDescription = [
  {
    ...
    list: [
      {
        title: 'Site Analysis and Evaluation: ',
        description:
          'Conducting thorough site analysis to assess the topography, climate, and surrounding environment to ensure the best possible design solution.',
      },
      {
        title: 'Conceptual Design: ',
        description:
          'Developing creative and innovative design concepts that align with the client’s needs, budget, and vision for the project.',
      },
      {
        title: 'Space Planning: ',
        description:
          'Efficiently planning the interior layout to maximize space utilization, ensuring that each area meets the functional and aesthetic needs of its users.',
      },
      {
        title: 'Master Planning: ',
        description:
          'Creating master plans for large-scale developments, including residential, commercial, and mixed-use projects, with a focus on long-term sustainability and growth.',
      },
      {
        title: 'Building Code Compliance: ',
        description:
          'Ensuring that all designs comply with local building codes, zoning regulations, and safety standards.',
      },
      {
        title: 'Sustainability and Green Architecture: ',
        description:
          'Incorporating sustainable practices and green building techniques to reduce energy consumption, environmental impact, and promote eco-friendly designs.',
      },
      {
        title: '3D Visualization and Modeling: ',
        description:
          'Using advanced software to create 3D models and renderings that allow clients to visualize the final design and make informed decisions.',
      },
      {
        title: 'Structural Integration: ',
        description:
          'Ensuring the architectural design is harmoniously integrated with the structural system, ensuring safety, stability, and functionality.',
      },
      {
        title: 'Interior Design Planning: ',
        description:
          'Designing the interior layout, furniture, and decorative elements to create a functional and aesthetically pleasing environment.',
      },
      {
        title: 'Project Feasibility Studies: ',
        description:
          'Conducting feasibility studies to determine the practicality, cost-effectiveness, and viability of the proposed design solutions.',
      },
    ],
    sectors: [
      {
        ...
        description:
          'Planning and designing homes, apartments, and housing developments, focusing on comfort, functionality, and aesthetic appeal.',
      },
      {
        title: 'Commercial and Office Spaces: ',
        description:
          'Providing architectural planning for office buildings, retail spaces, and commercial developments, ensuring efficiency and workability.',
      },
      {
        title: 'Industrial and Manufacturing Facilities: ',
        description:
          'Designing layouts for factories, warehouses, and industrial plants, ensuring optimized workflows and adherence to safety standards.',
      },
      {
        title: 'Healthcare Facilities: ',
        description:
          'Architecting spaces for hospitals, clinics, and healthcare facilities, focusing on patient comfort, staff efficiency, and regulatory compliance.',
      },
      {
        title: 'Education and Institutional Buildings: ',
        description:
          'Designing schools, colleges, and universities with a focus on creating conducive learning environments and optimizing space usage.',
      },
      {
        title: 'Public and Civic Buildings: ',
        description:
          'Providing architectural planning for government buildings, community centers, and civic spaces, ensuring accessibility and public safety.',
      },
      {
        title: 'Retail and Hospitality: ',
        description:
          'Designing retail outlets, hotels, and restaurants with a focus on customer experience, functionality, and brand identity.',
      },
      {
        title: 'Mixed-Use Developments: ',
        description:
          'Planning mixed-use developments that combine residential, commercial, and recreational spaces in a harmonious and integrated design.',
      },
    ],
  },
  {
    ...
    list: [
      {
        ...
        description:
          'Studying current market trends and comparable sales to estimate property value.',
      },
      {
        title: 'Asset Evaluation: ',
        description:
          'Assessing the value of tangible and intangible assets, including machinery, equipment, and intellectual property.',
      },
      {
        title: 'Land Valuation: ',
        description:
          'Estimating the worth of land based on location, zoning, and development potential.',
      },
      {
        title: 'Building Assessment: ',
        description:
          'Analyzing the condition, structure, and functionality of buildings to determine value.',
      },
      {
        title: 'Financial Analysis: ',
        description:
          'Evaluating income potential and investment returns for financial valuation.',
      },
      {
        title: 'Legal Compliance: ',
        description:
          'Ensuring valuations meet regulatory standards and legal requirements.',
      },
      {
        title: 'Tax Assessment: ',
        description:
          'Providing accurate valuations for property tax and estate planning purposes.',
      },
      {
        title: 'Risk Assessment: ',
        description:
          'Identifying potential risks that may impact property or asset value.',
      },
      {
        title: 'Customized Reporting: ',
        description:
          'Delivering detailed, client-specific valuation reports for informed decision-making.',
      },
      {
        title: 'Valuation for Transactions: ',
        description:
          'Providing valuations for buying, selling, leasing, or financing purposes.',
      },
    ],
    sectors: [
      {
        ...
        description:
          'Valuating residential properties, including houses, apartments, and condominiums, for sale, purchase, or investment purposes.',
      },
      {
        title: 'Commercial Sector: ',
        description:
          'Providing valuations for office buildings, retail spaces, industrial facilities, and mixed-use developments.',
      },
      {
        title: 'Industrial Sector: ',
        description:
          'Valuating factories, warehouses, manufacturing plants, and other industrial properties based on location, condition, and production capacity.',
      },
      {
        title: 'Agricultural Sector: ',
        description:
          'Valuating agricultural land, farms, and related assets, including crops, equipment, and livestock.',
      },
      {
        title: 'Financial Assets: ',
        description:
          'Valuating intangible assets such as intellectual property, stocks, bonds, and investment portfolios.',
      },
      {
        title: 'Insurance Valuation: ',
        description:
          'Providing accurate property and asset valuations for insurance purposes, ensuring adequate coverage for potential losses.',
      },
      {
        title: 'Legal and Tax Compliance: ',
        description:
          'Providing valuation services for legal proceedings, estate planning, tax assessments, and compliance with regulatory bodies.',
      },
      {
        title: 'Corporate Assets: ',
        description:
          'Valuating corporate assets, including machinery, equipment, inventory, and intellectual property, for mergers, acquisitions, or financial reporting.',
      },
    ],
  },
  {
    ...
    list: [
      {
        title: 'Real Estate Sector Valuation: ',
        description:
          'Valuation of machinery used in real estate development, including construction, property management, and facility operations.',
      },
      {
        title: 'Hospitality Sector Valuation: ',
        description:
          'Providing accurate valuation for machinery in the hospitality industry, including equipment in hotels, resorts, and restaurants.',
      },
      {
        title: 'Healthcare Sector Valuation: ',
        description:
          'Valuing medical equipment and machinery used in hospitals, clinics, and healthcare institutions for financing or insurance purposes.',
      },
      {
        title: 'Power and Renewable Energy: ',
        description:
          'Assessing the value of plant and machinery used in power generation, including renewable energy sources like solar, wind, and hydroelectric.',
      },
      {
        title: 'Oil & Gas Industry Valuation: ',
        description:
          'Valuation of machinery and equipment used in the oil and gas industry, including exploration, production, and refining processes.',
      },
      {
        title: 'FMCG and Pharmaceuticals: ',
        description:
          'Valuing machinery and equipment used in the production and distribution of fast-moving consumer goods and pharmaceuticals.',
      },
      {
        title: 'Automobile and Tyre Manufacturing: ',
        description:
          'Providing valuations for machinery used in the automobile and tyre manufacturing processes.',
      },
      {
        title: 'Industrial and Manufacturing Sector: ',
        description:
          'Valuation of plant machinery used in large-scale industrial and manufacturing facilities for purchase, sale, or financing purposes.',
      },
      {
        title: 'Paper, Cement, Iron & Steel: ',
        description:
          'Valuation services for machinery in heavy industries such as cement production, paper mills, and steel manufacturing.',
      },
    ],
    sectors: [
      {
        title: 'Multinational Corporates: ',
        description:
          'Offering machinery valuation services to multinational companies to assist with mergers, acquisitions, and financial reporting.',
      },
      {
        title: 'Government and Regulators: ',
        description:
          'Providing accurate valuations for government departments, regulators, and public sector organizations for asset management and compliance.',
      },
      {
        title: 'Banks and Financial Institutions: ',
        description:
          'Assisting domestic and international banks, as well as non-banking financial companies, with valuations required for financing and collateral purposes.',
      },
      {
        title: 'Insurance Companies and Brokers: ',
        description:
          'Helping insurance firms assess the value of machinery and plant for underwriting, claims, and risk management purposes.',
      },
      {
        title: 'Law Firms and Courts: ',
        description:
          'Providing expert testimony and valuation support for litigation and dispute resolution, including court cases and NCLT matters.',
      },
    ],
    coverage: {
      asset_classes: [
        {
          ...
          description:
            'Valuing office machinery and related assets for businesses and institutions.',
        },
        {
          title: 'Retail and Commercial Equipment: ',
          description:
            'Assessing machinery and equipment used in retail outlets, supermarkets, and commercial establishments.',
        },
        {
          title: 'Data Centres and Warehouse Machinery: ',
          description:
            'Valuation of machinery used in data centers and warehouses, including IT infrastructure and storage systems.',
        },
        {
          title: 'Industrial Equipment: ',
          description:
            'Valuing heavy machinery and plant equipment used in large industrial sectors including manufacturing and infrastructure projects.',
        },
      ],
      valuation_purpose: [
        {
          ...
          description:
            'Providing machinery valuations to determine the allocation of purchase price in mergers and acquisitions.',
        },
        {
          title: 'Financing and Collateral: ',
          description:
            'Valuing plant and machinery for financing purposes and to serve as collateral for loans or credit facilities.',
        },
        {
          title: 'Litigation Support and Expert Testimony: ',
          description:
            'Providing expert valuation services for legal proceedings, including litigation, arbitration, and expert testimony.',
        },
        {
          title: 'Acquisition and Disposition: ',
          description:
            'Helping clients with valuations for buying or selling machinery, ensuring accurate market value assessments.',
        },
        {
          title: 'Insurance Valuation: ',
          description:
            'Providing valuations to ensure accurate insurance coverage for plant and machinery, mitigating risks of under- or over-insurance.',
        },
        {
          title: 'Asset Tagging and Management: ',
          description:
            'Offering asset tagging services to ensure accurate tracking and management of machinery for audit and regulatory purposes.',
        },
      ],
    },
  },
    ...
    list: [
      {
        title: 'Eligibility Assessment: ',
        description:
          'Assessing the qualifications, experience, and skillset of engineers to determine eligibility for Chartered Engineer certification.',
      },
      {
        title: 'Application Guidance: ',
        description:
          'Providing step-by-step assistance with the application process, ensuring all required documentation and evidence are submitted for review.',
      },
      {
        title: 'Competency Evaluation: ',
        description:
          'Evaluating an engineer’s competency through a thorough review of their technical knowledge, practical experience, and professional achievements.',
      },
      {
        title: 'Professional Development Support: ',
        description:
          'Offering advice on continuing professional development (CPD) programs, workshops, and courses to meet the requirements for certification.',
      },
      {
        title: 'Ethical and Regulatory Compliance: ',
        description:
          'Ensuring that applicants meet the ethical, legal, and regulatory standards set by certifying bodies and industry associations.',
      },
      {
        title: 'Portfolio Review and Submission: ',
        description:
          'Assisting engineers in preparing a comprehensive portfolio that highlights their qualifications, experience, and completed projects.',
      },
      {
        title: 'Mentorship and Coaching: ',
        description:
          'Providing mentorship and coaching sessions to guide engineers through the certification process, offering professional insights and feedback.',
      },
      {
        title: 'Written and Oral Examinations: ',
        description:
          'Facilitating the preparation and submission of written reports and conducting oral examinations to assess an engineer’s practical knowledge and expertise.',
      },
      {
        title: 'Chartered Engineer Certification Issuance: ',
        description:
          'Issuing the official Chartered Engineer Certification upon successful evaluation, recognizing the individual’s qualifications and capabilities.',
      },
      {
        title: 'Renewal and Re-certification: ',
        description:
          'Assisting with the renewal of certifications and ensuring engineers continue to meet professional development requirements.',
      },
    ],
    sectors: [
      {
        ...
        description:
          'Providing Chartered Engineer Certification for civil, structural, and mechanical engineers working in construction, design, and infrastructure projects.',
      },
      {
        title: 'Mechanical Engineering: ',
        description:
          'Supporting mechanical engineers in obtaining Chartered Engineer status for work in manufacturing, design, and industrial applications.',
      },
      {
        title: 'Electrical Engineering: ',
        description:
          'Assisting electrical engineers in obtaining certification for their expertise in electrical design, systems, and power generation sectors.',
      },
      {
        title: 'Aerospace and Aviation: ',
        description:
          'Providing certification services for engineers working in the aerospace and aviation industries, ensuring compliance with international standards.',
      },
      {
        title: 'Automotive Engineering: ',
        description:
          'Supporting automotive engineers in achieving Chartered Engineer status for their work in vehicle design, testing, and manufacturing.',
      },
      {
        title: 'Energy and Utilities: ',
        description:
          'Assisting engineers in the energy sector to obtain Chartered Engineer certification for work in power generation, renewable energy, and utilities.',
      },
      {
        title: 'Oil & Gas: ',
        description:
          'Providing certification services for engineers working in the oil and gas industry, ensuring that they meet industry-specific standards and regulations.',
      },
      {
        title: 'Telecommunications: ',
        description:
          'Helping engineers in the telecommunications industry achieve Chartered Engineer status, validating their expertise in network design, maintenance, and development.',
      },
      {
        title: 'Environmental Engineering: ',
        description:
          'Assisting environmental engineers in obtaining Chartered Engineer certification for their work in environmental protection, sustainability, and resource management.',
      },
      {
        title: 'Manufacturing: ',
        description:
          'Providing Chartered Engineer Certification for engineers in the manufacturing sector, focusing on quality control, process optimization, and system design.',
      },
    ],
  },
  {
    ...
    list: [
      {
        ...
        description:
          'Assessing the adherence of industrial operations to relevant safety regulations and standards set by regulatory authorities and industry best practices.',
      },
      {
        title: 'Risk Assessment: ',
        description:
          'Identifying potential safety hazards across all areas of the facility, including machinery, processes, and human factors, and providing mitigation strategies.',
      },
      {
        title: 'Hazardous Materials Management: ',
        description:
          'Evaluating the safe handling, storage, and disposal of hazardous materials to minimize environmental impact and health risks.',
      },
      {
        title: 'Workplace Safety Culture Evaluation: ',
        description:
          'Analyzing the safety culture within the organization, including employee safety training, awareness, and engagement in safety protocols.',
      },
      {
        title: 'Emergency Response Preparedness: ',
        description:
          'Evaluating emergency response plans, including evacuation procedures, fire safety systems, and first aid readiness, to ensure quick and effective actions during emergencies.',
      },
      {
        title: 'Equipment Safety and Maintenance: ',
        description:
          'Assessing the safety of machinery and equipment, ensuring proper maintenance, guarding, and usage to prevent accidents or malfunctions.',
      },
      {
        title: 'Occupational Health & Safety (OHS) Assessment: ',
        description:
          'Reviewing occupational health and safety policies and practices to ensure a safe and healthy work environment, including ergonomics, ventilation, and PPE usage.',
      },
      {
        title: 'Safety Audit Reporting: ',
        description:
          'Providing detailed reports on audit findings, including safety performance metrics, identified risks, and recommended corrective actions.',
      },
      {
        title: 'Regulatory Compliance Certification: ',
        description:
          'Assisting with obtaining certifications for compliance with industry-specific safety regulations and standards such as ISO, OHSAS, and other local requirements.',
      },
      {
        title: 'Continuous Monitoring and Improvement: ',
        description:
          'Implementing systems for ongoing safety monitoring and offering suggestions for continuous improvement in safety standards and practices.',
      },
    ],
    sectors: [
      {
        title: 'Manufacturing: ',
        description:
          'Conducting safety audits in manufacturing plants to ensure safe working conditions, equipment maintenance, and regulatory compliance.',
      },
      {
        title: 'Construction: ',
        description:
          'Evaluating safety practices at construction sites, including site management, machinery safety, and worker protection protocols.',
      },
      {
        title: 'Oil & Gas: ',
        description:
          'Assessing safety protocols and hazard control measures in oil and gas operations, including exploration, drilling, and refining.',
      },
      {
        title: 'Chemical and Pharmaceutical Industries: ',
        description:
          'Performing safety audits in chemical and pharmaceutical manufacturing facilities, focusing on chemical handling, waste disposal, and environmental safety.',
      },
      {
        title: 'Energy and Utilities: ',
        description:
          'Assessing safety in energy production plants and utility operations, including power generation, transmission, and distribution.',
      },
      {
        title: 'Transportation and Logistics: ',
        description:
          'Reviewing safety protocols in transportation and logistics operations, including vehicle safety, warehouse management, and cargo handling.',
      },
      {
        title: 'Food and Beverage: ',
        description:
          'Conducting safety audits in food and beverage processing plants to ensure food safety, worker health, and compliance with hygiene regulations.',
      },
      {
        title: 'Retail and Warehousing: ',
        description:
          'Evaluating the safety of retail environments and warehouses, including fire safety, emergency preparedness, and employee health measures.',
      },
      {
        title: 'Mining: ',
        description:
          'Providing safety audits in mining operations, focusing on hazardous material handling, site management, and employee protection.',
      },
      {
        title: 'Automotive: ',
        description:
          'Assessing safety measures in automotive manufacturing and repair facilities, including equipment safety, worker protection, and process safety management.',
      },
    ],
  },

  {
    ...
    list: [
      {
        title: 'Pre-IPO Readiness Assessment: ',
        description:
          'Assessing the company’s financial health, legal standing, and operational readiness to go public, ensuring compliance with SEBI guidelines and stock exchange requirements.',
      },
      {
        title: 'Due Diligence Support: ',
        description:
          'Conducting a thorough due diligence process, including financial audits, legal reviews, and business operations assessments to ensure full transparency for potential investors.',
      },
      {
        title: 'Regulatory Compliance: ',
        description:
          "Ensuring compliance with SEBI, stock exchange, and other regulatory bodies' requirements, including corporate governance, financial reporting, and disclosures.",
      },
      {
        title: 'Drafting of Prospectus: ',
        description:
          'Assisting in the preparation of the IPO prospectus, covering essential information about the company’s business, financials, risks, and growth prospects for potential investors.',
      },
      {
        title: 'Financial Audit and Reporting: ',
        description:
          'Providing audit services to ensure that the company’s financial statements and performance reports are accurate, up-to-date, and in accordance with accounting standards.',
      },
      {
        title: 'Valuation Support: ',
        description:
          'Assisting in the valuation of the company to determine the offering price of the IPO, based on market conditions, financial performance, and industry comparisons.',
      },
      {
        title: 'Legal and Regulatory Documentation: ',
        description:
          'Providing legal support in preparing all required documentation, including filings with SEBI, the stock exchange, and other regulatory bodies.',
      },
      {
        title: 'Investor Relations and Communication: ',
        description:
          'Helping to manage investor communications, including roadshows, presentations, and media outreach, to generate interest in the IPO.',
      },
      {
        title: 'Post-IPO Compliance: ',
        description:
          'Ensuring that the company continues to meet all ongoing compliance requirements after the IPO, including financial reporting, corporate governance, and shareholder communications.',
      },
      {
        title: 'IPO Timing and Strategy: ',
        description:
          'Providing strategic advice on the optimal timing for the IPO, based on market conditions, business cycles, and investor sentiment.',
      },
    ],
    sectors: [
      {
        title: 'Technology: ',
        description:
          'Assisting tech companies in navigating the IPO process, ensuring their readiness for public listing and meeting regulatory requirements.',
      },
      {
        title: 'Healthcare and Pharmaceuticals: ',
        description:
          'Providing IPO certification services to healthcare and pharmaceutical companies, ensuring compliance with industry-specific regulations and financial transparency.',
      },
      {
        title: 'Retail and E-Commerce: ',
        description:
          'Helping retail and e-commerce companies prepare for an IPO by assessing business performance, legal requirements, and market conditions.',
      },
      {
        title: 'Financial Services: ',
        description:
          'Guiding financial service companies through the IPO process, ensuring compliance with SEBI guidelines, and preparing financial audits and disclosures.',
      },
      {
        title: 'Manufacturing: ',
        description:
          'Supporting manufacturing companies in the IPO process, focusing on corporate governance, valuation, and compliance with public offering regulations.',
      },
      {
        title: 'Energy and Infrastructure: ',
        description:
          'Providing IPO certification services to energy and infrastructure companies, ensuring adherence to environmental, financial, and operational regulations.',
      },
      {
        title: 'Consumer Goods: ',
        description:
          'Assisting consumer goods companies in preparing for IPO, from financial reporting to investor relations and regulatory compliance.',
      },
      {
        title: 'Telecommunications: ',
        description:
...
export const organization = [
  ...
  },
  {
    id: 3,
    name: 'Kishor Chopda',
    position: 'Sr. Associate Structural Engineer',
    experience: '16+ years',
  },
  {
    id: 4,
  ...
  {
    id: 5,
    name: 'Ashok Kumar Saha',
    position: 'Sr. Associate Project Engineer for Industrial Projects',
    experience: '23+ years',
  },
  {
    id: 6,
    name: 'Yogesh Chandak',
    position: 'Associate Plant & Machinery Valuer',
    experience: '22+ years',
  },
  {
    id: 7,
    name: 'Nitin Khune',
    position: 'Associate Electrical Consultant',
    experience: '25+ years',
  },

  {
    id: 8,
    name: 'Sandip Ganore',
    position: 'Associate Agriculture Land Consultant',
    experience: '20+ years',
  },
  {
    id: 9,
    name: 'Sunil Patil',
    position: 'Associate Architectural Planning & Designer',
    experience: '20+ years',
  },
  {
    id: 10,
    name: 'Sarfaraz Ansari',
    position: 'Civil D’man',
    experience: '7+ years',
  },
  {
    id: 11,
    name: 'Mahesh Dandagaval',
    position: 'Associate Quantity Survey & Billing',
    experience: '30+ years',
  },
  {
    id: 12,
    name: 'Atul Wagh',
    position: 'Associate Consultant & Structural Engineer',
    experience: '5+ years',
  },
  {
    id: 13,
    name: 'Pratik Sonvane',
    position: 'Associate Site Engineer, Quantity Survey & Billing',
    experience: '5+ years',
  },
  {
    id: 14,
    name: 'Rohit Chopra',
    position: 'Associate Valuation Engineer',
    experience: '3+ years',
  },
  {
    id: 15,
